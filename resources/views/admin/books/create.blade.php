...
<div class="m-portlet m-portlet--tab">
    ...
    <form class="m-form m-form--fit m-form--label-align-right" method="post" action="/manager/books">
        ...
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group row">
                <label class="col-form-label col-lg-3 col-sm-12" for="exampleTextarea">Detail</label>
                <div class="col-lg-6 col-md-9 col-sm-12">
                    <textarea name="detail" class="form-control m-input" id="exampleTextarea" rows="3"></textarea>
                </div>
            </div>
            <div class="form-group m-form__group row">
